...
namespace BookstoreManager
{
    public partial class XemCTNS : MaterialForm
    {
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString($"Mã Hóa Đơn: {txbMaNS.Text}", headerFont, Brushes.Black, x, y);
            y += 30;
            ...
            for (int i = 0; i < dtgvListCTNS.Rows.Count - 1; i++)
            {
                DataGridViewRow row = dtgvListCTNS.Rows[i];
